/**
 * Desktop pill control bar — undo / reset / save.
 */
...
export const DesktopControlBar: React.FC<DesktopControlBarProps> = ({
  ...
  <div className="hidden md:flex items-center gap-8 mt-8 bg-surface-container-lowest px-8 py-4 rounded-full border-2 border-outline-variant tactile-shadow-level-1">
    <button
      type="button"
      onClick={onUndo}
      disabled={!canUndo}
